void iDisplay(){
  ...
  // interaction key 
    ...
    text("Press [h] for hanging view and [r] for top view",0,0*tS);
    text("Press [space] to allow free rotation", 0,3*tS);
    text("Press [i] to toggle text interface",0,4*tS);
    text("Press [l] to toggle labels",0,5*tS);
    popMatrix();
